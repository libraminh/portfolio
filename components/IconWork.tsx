const IconWork = () => {
  return (
    <div className="border border-solid border-gray-900 dark:border-0 bg-transparent dark:bg-white dark:bg-opacity-90 inline-flex justify-center items-center w-12 h-12 rounded-full basis-12">
      <svg
        version="1.1"
      ...
      >
        ...
        <path
          ...
          d="M29,2H3C1.9,2,1,2.9,1,4v19c0,1.1,0.9,2,2,2h26c1.1,0,2-0.9,2-2V4C31,2.9,30.1,2,29,2z M29,20
